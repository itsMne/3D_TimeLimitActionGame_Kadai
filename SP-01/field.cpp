...
static VERTEX_3D					g_vertexWk[NUM_VERTEX];	// 頂点情報格納ワーク
...
static XMFLOAT4X4					g_mtxWorldField;		// ワールドマトリックス
static XMFLOAT4X4					g_mtxTexture;			// テクスチャマトリックス
static XMFLOAT3						g_posField;				// 現在の位置
static XMFLOAT3						g_rotField;				// 現在の向き

// マテリアル
static XMFLOAT4						g_Ka;		// アンビエント
static XMFLOAT4						g_Kd;		// ディフューズ
static XMFLOAT4						g_Ks;		// スペキュラ
static float						g_fPower;	// スペキュラ強度
static XMFLOAT4						g_Ke;		// エミッシブ
